...
# initialize clients B1 and B2 with account name and balance
# Store clients info into a file name balance_B.txt (Account#:Unconfirmed_balance:Confirmed_balance)
# e.g B0000001:0x000003E8:0x000003E8
# place their information into a txt file
clientAccount =['B0000001','B0000002']
clientBalance = ['0x000003E8','0x000003E8']
with open('balance_B.txt', 'w') as w:
...
# The input is a transaction that will be sent to F2
...
def unconfirmed_balance(account_number, Tx_amount):
    ...
    # open balance_B.txt which holds the unconfirmed balance
    with open('balance_B.txt', 'r') as f:
...
while True:
    ...
    if userInput == 1:
        ...
        if confirm:
            ...
            Tx = [payer,payee,amount,'client_B']
    ...
    # Second Case: Print current balance for each account
        ...
        balance_B1 = account_balance[0].split(':')  # first balance
        balance_B2 = account_balance[1].split(':')  # second balance
        balance_of_B1 = convert_hex_toDecimal(balance_B1[2])
        balance_of_B2 = convert_hex_toDecimal(balance_B2[2])
        print(clientAccount[0] + ' has a balance of ' + str(balance_of_B1) + ' BC')
        print(clientAccount[1] + ' has a balance of ' + str(balance_of_B2) + ' BC')
